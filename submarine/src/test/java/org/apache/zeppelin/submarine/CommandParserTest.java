...
public class CommandParserTest {
  ...
  public void testParser() {
    ...
    Scanner sc = new Scanner(SubmarineConstants.INPUT_PATH+ "=hi!\n"
        ...
        + "job run\n"
        + SubmarineConstants.WORKER_LAUNCH_CMD + " and long config name containing spaces = phew! it worked!");
    parser.populate(sc);
    ...
    assertEquals("phew! it worked!", parser.getConfig(SubmarineConstants.WORKER_LAUNCH_CMD + " AND LONG CONFIG NAME CONTAINING SPACES"));
  }
}
