...
/**
 * Tests for Submarine Interpreter.
 */
public class SubmarineInterpreterTest {
  private static Logger logger = LoggerFactory.getLogger(SubmarineInterpreterTest.class);
  private static SubmarineInterpreter submarineInterpreter;
  ...
  public static void setUp() throws NullPointerException, InterpreterException {
    ...
    submarineInterpreter = new SubmarineInterpreter(properties);
    submarineInterpreter.open();
  }
  
  @Test
  public void newObject() {
    assertThat(submarineInterpreter, notNullValue());
  }

  @Test
  public void putsTest() {
    InterpreterResult result = submarineInterpreter.interpret("puts \"Hello World\"", null);
  ...
  public void putsLoadPath() {
    InterpreterResult result = submarineInterpreter.interpret(
  ...
  public void testException() {
    InterpreterResult result = submarineInterpreter.interpret("plot practical joke", null);
