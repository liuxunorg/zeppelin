...
public class YarnRemoteInterpreterProcess extends RemoteInterpreterManagedProcess {
  ...
  public YarnRemoteInterpreterProcess(
    ...
    super(intpRunner, zeppelinServerRPCPort, zeppelinServerRPCHost, interpreterPortRange,
        intpDir, localRepoDir, env, connectTimeout, interpreterSettingName, interpreterGroupId,
        isUserImpersonated);
