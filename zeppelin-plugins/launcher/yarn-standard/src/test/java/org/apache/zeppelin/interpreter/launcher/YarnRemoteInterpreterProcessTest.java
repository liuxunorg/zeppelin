...
public class YarnRemoteInterpreterProcessTest {
  ...
  public void testLauncher() throws IOException {
    ...
    assertTrue(interpreterProcess.getConnectTimeout()>= 300000);
    ...
    assertEquals("--localization \":/zeppelin/conf/log4j.properties:rw\" --localization \"keytab_value:keytab_value:rw\" ", interpreterProcess.getEnv().get("YARN_LOCALIZATION_ENV"));
