...
public class ClusterManagerServer extends ClusterManager
  ...
  public boolean createClusterInterpreterProcess(ClusterIntpProcParameters clusterIntpProcParameters) {
    String userName = clusterIntpProcParameters.userName;
    String noteId = clusterIntpProcParameters.noteId;
    String replName = clusterIntpProcParameters.replName;
    String defaultInterpreterSetting = clusterIntpProcParameters.defaultInterpreterSetting;

    try {
      Interpreter interpreter = interpreterFactory.getInterpreter(
          userName, noteId, replName, defaultInterpreterSetting);
